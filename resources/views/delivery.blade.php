...
@section('title')
    <title>Доставка - Єнот-24</title>
    <meta property="Доставка - Єнот-24">
@endsection
...
@section('content')
    <div class="box-container-block">
        <div class="box delivery-page">
            <div class="container">
                <div class="body-block">
                    <div class="box-elements">
                        <div class="delivery-card">
                            <div class="banner-card">
                                <img src="{{ asset('storage/src/delivery.png') }}" alt="Доставка Єнот-24">
                            </div>
                            <div class="content-card">
                                <div class="title">
                                    ...
                                    <p>
                                        <span>
                                            Вартість доставки у дві<br>сторони по Києву*:
                                        </span>
                                        <b>
                                            350 грн**
                                        </b>
                                ...
                                <div class="info-d">
                                    <h2>Важливо</h2>
                                    <p>*Якщо ліфт не працює, забір або доставка замовлення до 3-го поверху – БЕЗКОШТОВНО;</p>
                                    <p>підйом замовлення до дверей – 25 грн/поверх.</p>
                                    <p>** Вартість доставки за межі міста уточнюйте при замовленні</p>
                                </div>
                            </div>
                        </div>
                    </div>
